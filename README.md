...
* Converts a free Tasmac HTML template to an Angular app
...
* Includes code from [AdMISTER STUDIOs](https://www.youtube.com/c/AdMISTERSTUDIOs/featured) - see [:clap: Inspiration](#clap-inspiration) below, but with changes to reduce lines of code and use latest Angular version. Some of the videos listed below are not applicable as I decided to just reproduce the Tasmac website and not include a blog, user login/logoff, auth guard, separate API etc.
...
* [One Page Love website of html templates](https://onepagelove.com/Tasmac)
